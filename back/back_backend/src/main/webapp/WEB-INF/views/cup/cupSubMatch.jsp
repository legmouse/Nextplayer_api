      ...
      <div class="round body">
        ...
        <div class="title">
          <h3 class="w100">
            ...
            <a class="btn-large gray-o" onclick="gotoCupTeam('${cupId}');">수정</a>
          </h3>
        </div>
          ...
          <tbody>
            <tr>
              ...
              <td class="tr">
				...
				<a class="btn-large default" onclick="gotoAddExcel();" >예선일정 일괄 등록</a>
                ...
                <c:choose>
                    <c:when test="${teamType == '1' or teamType == ''}">
                        <c:forEach var="i" begin="1" end="${cupInfoMap.group_count }" step="1">
                            <a class="btn-large w6 btn-tab" data-id="num${i}" onclick="gotoCupMatch(${i});">${i}조</a>
                        </c:forEach>
                    </c:when>
        ...
        <div class="scroll">
        <form name="frm" id="frm" method="post"  action="save_cupSubMatch">
        ...
        <table id="frmTB"cellspacing="0" class="update">
		  ...
		  <tbody id="tblmId">
          	<c:if test="${empty cupSubMatchList}">
				<tr class="item0">
					<td id="idEmptyList" colspan="6">등록된 내용이 없습니다.</td>
					<%--<td id="idEmptyList" colspan="6">
                        <a class="btn-pop" data-id="find-club" onclick="addInput"><i class="xi-plus-circle-o"></i></a>
                    </td>--%>
				</tr>
			</c:if>
			...
			<tr class="item${status.index}">
				<td>
					...
					<input name="cupSubMatchId${status.index}" type="hidden" value="${result.cup_sub_match_id}">
...
<%--				  <a onclick="removeTeamMatch(${status.index});"><i class="xi-close-circle-o"></i></a>--%>
				  <a onclick="removeTeamMatch(${status.index}, ${result.cup_sub_match_id});"><i class="xi-close-circle-o"></i></a>
				</td>
			</tr>
			</c:forEach>
          </tbody>
        ...
        <div class="body-foot">
          ...
          <div class="others">
          	<a class="btn-large default" onclick="gotoDelCupSubMatch(2);">일정 일괄 삭제</a>
          	...
          	<c:otherwise>
          		<c:if test="${fn:length(cupSubMatchList) eq 0}">
          			<a class="btn-large default" onclick="gotoAddLeagueTeam(0);">예선일정 등록</a>
          		</c:if>
          		<c:if test="${fn:length(cupSubMatchList) ne 0}">
          			<a class="btn-large default" onclick="gotoAddLeagueTeam(1);">예선일정 수정</a>
          		</c:if>
	            <!-- <a class="btn-large default" onclick="gotoAddLeagueTeam(1);">예선일정 수정</a> -->
	            <!-- <a class="btn-large gray-o" onclick="gotoAddLeagueMatch(1);">예선일정 수정 후 팀 생성</a> -->
<!-- 임시이동 -->
	            <c:if test="${cupInfoMap.cup_type eq 0}">
	            <a class="btn-large gray-o" onclick="gotoAddCupTourMatch('${cupInfoMap.cup_id}');">토너먼트 일정등록 이동</a>
	            </c:if>
	            <c:if test="${cupInfoMap.cup_type eq 1}">
	            <a class="btn-large gray-o" onclick="gotoAddCupMainTeam('${cupInfoMap.cup_id}');">본선 팀등록 이동</a>
	            </c:if>
...
<form name="cmfrm" id="cmfrm" method="post"  action="cupSubMatch">
...
<form name="delFrm" id="delFrm" method="post"  action="save_cupSubMatch" onsubmit="return false;">
