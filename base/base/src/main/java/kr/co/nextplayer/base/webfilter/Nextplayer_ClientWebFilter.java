...
@Slf4j
@Component
public class Nextplayer_ClientWebFilter extends PathPatternWebFilter {
    private final String clientId;

    public Nextplayer_ClientWebFilter(NextplayerProperty nextplayerProperty) {
        this.clientId = nextplayerProperty.getClientId();

        this.addIncludePathPatterns("/*/*/api/v1/**");
