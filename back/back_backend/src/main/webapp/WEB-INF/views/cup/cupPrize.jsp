...
<script type="text/javascript">
    ...
    const fnMakeParamData = () => {
        ...
        cupInputs.each(function() {
            ...
            const data = param.cupData.find(item => item.ageGroup === ageGroup && item.foreignId === foreignId);
            if (data) {
    ...
    const fnSearchCup =() => {
        const sCupYear = $("#sCupYear option:selected").val();
    ...
    const closeCupPop = () => {
        ...
        const listStr = '<td colspan="3">대회 검색후 선택해 주세요.</td>';
        $("#cupList").append(listStr);
        $("#sCupName").val(null);
        ...
        <div class="round body">
            ...
            <div class="title">
                <h3>
                    ...
                    <a onclick="gotoFixCupInfo('${cupId}');" class="btn-large gray-o">수정</a>
                </h3>
            </div>
            ...
            <form name="frm" id="frm" action="save_cupPrize" onsubmit="return false;">
                ...
                <div class="scroll">
                    <table cellspacing="0" class="update">
                        ...
                        <tr>
                            <td class="tl">
                                <textarea name="cInfo" style="min-height:200px;">${cupInfoMap.cup_info}</textarea>
                            </td>
                            <td class="tl">
                                <textarea name="cPrize" style="min-height:200px;">${cupInfoMap.cup_prize}</textarea>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <div id="selectedCup"></div>
                    <div id="deleteCup"></div>
                </div>
            </form>
            ...
            <div class="body-foot">
                ...
                <div class="others">
                    <c:choose>
                        <c:when test="${(ageGroup eq 'U11' or ageGroup eq 'U12') and cupInfoMap.cup_type eq '4'}">
                            <c:choose>
                                <c:when test="${sFlag eq '0' }">
                                    <a class="btn-large default" onclick="gotoCupPrize(0);">개요등록</a>
                                    <a class="btn-large gray-o" onclick="gotoCupTeamFullLeague(0, 1);">개요등록 후 참가팀1 등록</a>
                                    <a class="btn-large gray-o" onclick="gotoCupTeamFullLeague(0, 2);">개요등록 후 참가팀2 등록</a>
                                </c:when>
                                <c:when test="${sFlag eq '1' }">
                                    <a class="btn-large gray-o" onclick="gotoCupPrize(1);">개요수정</a>
                                    <a class="btn-large gray-o" onclick="gotoCupTeamFullLeague(1, 1);">개요수정 후 참가팀1 등록</a>
                                    <a class="btn-large gray-o" onclick="gotoCupTeamFullLeague(1, 2);">개요수정 후 참가팀2 등록</a>
                                </c:when>
                            </c:choose>
                        </c:when>
                        <c:otherwise>
                            <c:choose>
                                <c:when test="${sFlag eq '0' }">
                                    <a class="btn-large default" onclick="gotoCupPrize(0);">개요등록</a>
                                    <a class="btn-large gray-o" onclick="gotoCupTeam(0);">개요등록 후 참가팀 등록</a>
                                </c:when>
                                <c:when test="${sFlag eq '1' }">
                                    <a class="btn-large gray-o" onclick="gotoCupPrize(1);">개요수정</a>
                                    <a class="btn-large gray-o" onclick="gotoCupTeam(1);">개요수정 후 참가팀 등록</a>
                                </c:when>
                            </c:choose>
                        </c:otherwise>
                    </c:choose>
                ...
                <div style="height:auto;">
                    <div style="height:auto; width: 1100px;">
                        ...
                        <div class="head p10 grid4">
                            <select id="sCupYear" style="width:100px;">
