...
const goDetail = (val) => {
    ...
    newForm.attr('name', 'newForm');
    newForm.attr('method', 'post');
    newForm.attr('action', '/popupDetail');
  ...
  <div class="wrapper" id="wrapper">
    ...
    <div class="contents active">
      ...
      <div class="round body">
        <div class="body-head">
          <div class="search">
            <form name="frm" id="frm" method="post"  action="popupList" onsubmit="return false;">
          ...
          <div class="others">
            <a class="btn-large default btn-pop" data-id="update-area-add" onclick="gotoModify()">팝업 등록</a>
          </div>
        </div>
        <br />
        <br />
        <table cellspacing="0" class="update">
          ...
          <tbody>
			...
			<tr onclick="goDetail('${result.popup_id}')">
				<td>
					<c:choose>
				...
				<td>${result.title}</td>
				<td>${result.show_sdate} ~ ${result.show_edate}</td>
