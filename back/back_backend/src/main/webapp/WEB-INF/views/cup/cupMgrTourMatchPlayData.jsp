			...
			<div style="width: 45%;float: left;clear: both;">
				<div class="title">
					...
					<table cellspacing="0" class="update">
						...
						<tbody>
							<c:choose>
								<c:when test="${empty homeOwnGoalDataList}">
									<tr>
										<td colspan="3">
											등록된 데이터가 없습니다.
										</td>
								...
								<c:otherwise>
									<c:forEach var="e" items="${homeOwnGoalDataList}" varStatus="status">
										<tr>
											<td class="tl">
													${e.time}
											</td>
			...
			<div style="width: 45%;float: left; margin-left: 10%;">
				<div class="title">
					...
					<table cellspacing="0" class="update">
						...
						<tbody>
						<c:choose>
							<c:when test="${empty awayOwnGoalDataList}">
								<tr>
									<td colspan="3">
										등록된 데이터가 없습니다.
									</td>
							...
							<c:otherwise>
								<c:forEach var="e" items="${awayOwnGoalDataList}" varStatus="status">
									<tr>
										<td class="tl">
												${e.time}
										</td>
