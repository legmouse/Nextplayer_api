...
@MapperScan(value = "kr.co.nextplayer.base.backend.storeMapper", sqlSessionFactoryRef = "StoreSqlSessionFactory")
public class BackendStoreConfig {
    ...
    public SqlSessionFactory StoreSqlSessionFactory(@Qualifier(STORE_DATA_SOURCE) DataSource dataSource) throws Exception {
        ...
        Resource[] res = new PathMatchingResourcePatternResolver().getResources("classpath:storeMapper/*Mapper.xml");
    ...
    @Bean
    public DataSourceTransactionManager BTransactionManager(@Qualifier(STORE_DATA_SOURCE) DataSource dataSource) {
