...
public class Define {
	public static final String ROOT_URL = "/NPAdm/";

	//public static final boolean TEST_BED = true; // LOCAL
    public static final boolean TEST_BED = false; // LIVE

    /**
     * 운영에 배포 할땐 IS_DEV false 활성될 수 있게
     */
    public static final boolean IS_DEV = true; // 개발 환경
    //public static final boolean IS_DEV = false; // 운영 환경

	//public static final String LOCAL_WEB_PATH = "http://192.168.1.36:8124/NP"; // local server qwqwqw
	public static final String LOCAL_WEB_PATH = "http://192.168.1.12:8124/NP"; // local server qwqwqw
	public static final String LIVE_WEB_PATH = "https://mobile.nextplayer.co.kr/NP"; // LIVE server

	public static final String LOCAL_SAVE_FILE_PATH = "/Users/igp/content_nextplayer/";// "/content_nextplayer/upload/";
																					// //common
	...
	public static final int LEAGUE_MATCH_Column = 10; // 리그 경기일정 정보 엑셀 컬럼 갯수
	...
	public static final int CUP_SUB_MATCH_Column = 12; // 대회 예선 경기일정 정보 엑셀 컬럼 갯수
	public static final int CUP_MAIN_MATCH_Column = 12; // 대회 본선 경기일정 정보 엑셀 컬럼 갯수
	public static final int CUP_TOUR_MATCH_Column = 15; // 대회 토너먼트 경기일정 정보 엑셀 컬럼 갯수
	...
	public static final String MODE_DELETE_ONE = "3";

	public static final String MODE_FIX_ONE = "4";
