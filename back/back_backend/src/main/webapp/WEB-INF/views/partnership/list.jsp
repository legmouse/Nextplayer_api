...
<head>
    ...
    <script type="text/javascript">
        ...
        const searchList = () => {
            ...
            newForm.attr('action', '/partnershipList');
        ...
        const goDetail = (val) => {
            ...
            newForm.attr('name', 'newForm');
            newForm.attr('method', 'post');
            newForm.attr('action', '/partnershipDetail');
...
<option>2014</option>
        ...
        <div class="round body">
            ...
            <div class="body-head">
                <a class="btn-large default" href="/partnershipList">제휴문의</a>
                <hr class="mt_10 mb_10">
                <div class="search">
                    <form name="frm" id="frm" method="post" action="/partnershipList" onsubmit="return false;">
            ...
            <div class="scroll">
                <table cellspacing="0" class="update over">
                    ...
                    <tbody>
                        <c:choose>
                            <c:when test="${empty partnershipList}">
                                <tr>
                                    <td colspan="7">등록된 공지가 없습니다.</td>
                                </tr>
                            </c:when>
                            <c:otherwise>
                                <c:forEach var="result" items="${partnershipList}" varStatus="status">
