 ...
 <div class="contents active">
      ...
      <div class="round body">
					...
					<c:forEach var="group_count" begin="0" step="1" end="${cupInfoMap.group_count-1}"> <!-- CELL 조 갯수 -->
			  			...
			  			<c:forEach var="result" items="${cupTeamList}" varStatus="status" begin="${cnt }" end="${cnt }">
			  				...
			  				<c:if test="${group_count+1 eq result.groups }">
					  			<td id="td${tdNum }" class="input2">[${result.team_type}] ${result.nick_name }</td>
			  				</c:if> 
        ...
        <div style="margin-bottom:20px;">
          <a class="btn-large default w6 btn-tab" data-id="num1">1조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num2">2조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num3">3조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num4">4조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num5">5조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num6">6조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num7">7조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num8">8조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num9">9조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num10">10조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num11">11조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num12">12조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num13">13조</a>
          <a class="btn-large gray-o w6 btn-tab" data-id="num14">14조</a>
        </div>
        
        
        <div class="scroll">
        <form name="frm" id="frm" method="post"  action="save_cupMatch" onsubmit="return false;">
        ...
        <table id="frmTB"cellspacing="0" class="update">
		  ...
		  <tbody id="tblmId">
          	<c:if test="${empty cupMatchList }">
				<tr class="item0">
					<td id="idEmptyList" colspan="6">등록된 내용이 없습니다.</td>
				</tr>
			</c:if>
			<c:forEach var="result" items="${cupMatchList}" varStatus="status"> 
