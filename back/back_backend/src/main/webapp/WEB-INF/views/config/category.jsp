...
function gotoModPopup(idx, uage, areaName){
	clearFrmData("modFrm");
        ...
        <table cellspacing="0" class="update">
          ...
          <tbody>
			...
			<tr>
				...
				<td class="admin">
	                <a class="btn-pop" data-id="modify-area-add" onclick="gotoModPopup('${result.area_id}','${result.uage}','${result.area_name}');"><i class="xi-catched"></i></a>
