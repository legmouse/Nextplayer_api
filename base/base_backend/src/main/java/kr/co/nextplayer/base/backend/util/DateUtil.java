...
public class DateUtil {
    ...
    public static int dayCompare(String cDay, String szDay) {
        int compare = parse(cDay, DateUtil.YYYYMMDD).compareTo(parse(szDay, DateUtil.YYYYMMDD));
    ...
    public static int getMonth() {
        ...
        // Calendar 객체로부터 현재 달(month)을 가져옴
        int currentMonth = calendar.get(Calendar.MONTH) + 1;

        System.out.println("현재 달: " + currentMonth);
        return currentMonth;
    }
...
//		System.out.println("-[getAddMinDateFormat :"+DateUtil.format(cal , DateUtil.YYYYMMDDTHHMM));
    ...
    public static String getYesterday() {
        ...
        rtnStr = sdfCurrent.format(cal.getTime());
